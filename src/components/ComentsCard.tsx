...
const accionesComentario: string[] = [
  ...
  "comenta esto 👇",
  "nos cuenta algo 👀",
  "deja su comentario ✍️",
  "opina por aquí 🗣️",
  "nos deja esto 💬",
  "comparte su opinión 👇",
  "dice lo que piensa 💭",
  "comenta lo siguiente 👀",
  "deja su punto de vista ✨",
  "nos cuenta su idea 💡",
  "dice qué le parece 👇",
  ...
  "nos comenta esto ✨",
  "dice lo que opina 💬",
  "deja su granito de arena 💡",
  "comenta su experiencia 👀",
  "nos dice qué piensa 💭",
  "comparte su punto 👇",
  "dice lo que siente 💖",
  "deja su comentario aquí 💬",
  "nos cuenta su versión 👀",
  "opina desde su experiencia ✨",
  "dice lo que le parece 💬",
  "comenta algo rápido 👇",
  "nos deja su impresión 👀",
  "opina con buena vibra 💖",
];
    ...
    >
      <div className="card-gradient rounded-2xl p-6 md:p-8 border border-border/50">
        ...
        <h3 className="text-lg font-semibold mt-6 mb-2">
          Mira los comentarios que representan a vdmm-services:
        </h3>

  ...
  return (
    ...
    >
      <div className="card-gradient rounded-2xl p-6 md:p-8 border border-border/50">
        <h2 className="font-display font-semibold text-xl text-foreground mb-6">Deja tu comentario</h2>
        ...
        <h3 className="text-lg font-semibold mt-6 mb-2">Lo que se comenta de V-Services:</h3>

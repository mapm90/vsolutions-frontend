...
const accionesComentario: string[] = [
  ...
  "nos brinda su opinión 💡",
  "ha querido aportar su visión 👀",
  "comparte su reflexión ✨",
  "nos envía su comentario 📩",
  "nos hace llegar su mensaje 🗨️",
  "nos comenta lo siguiente 👇",
  "ha expresado esto 📝",
  "nos comparte su punto de vista 🗣️",
  "nos deja su reflexión ✨",
  "quiso hacernos saber esto 💬",
  "nos cuenta su experiencia 👀",
  "ha escrito estas palabras ✍️",
  "nos comparte su mensaje 📬",
  "quiso expresar esto 👇",
  "dejó su comentario final 🗨️",
];
